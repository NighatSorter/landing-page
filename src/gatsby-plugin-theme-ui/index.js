export default {
  ...
  colors: {
    text: '#000033', // body color and primary color
    ...
    borderColor: '#000033', // border color
    primary: '#000033', // primary button and link color
    secondary: '#1AD9D5', // secondary color - can be used for hover states
